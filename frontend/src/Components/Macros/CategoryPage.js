...
const LandingPage = () => {
  ...
  useEffect(() => {
    ...
    fetchData();
  }, [currentCategoryPage, status_id, name]);
  ...
  const renderPaginationSearch = () => {
    ...
    return (
      <div className="flex items-center justify-center mt-4">
        <button
          className={`mr-2 px-4 py-2 rounded ${
            currentCategoryPage === 1 ? 'hidden' : 'bg-blue-500 hover:bg-blue-600 text-white'
          }`}
        ...
        {pageNumbers.map((pageNumber) => (
          <button
            key={pageNumber}
            className={`mx-1 px-3 py-1 rounded ${
              currentCategoryPage === pageNumber ? 'bg-blue-500 text-white' : ' text-white'
            }`}
        ...
        <button
          className={`ml-2 px-4 py-2 rounded ${
            currentCategoryPage === totalCategoryPage ? 'hidden' : 'bg-blue-500 hover:bg-blue-600 text-white'
          }`}
          onClick={() => handlePageChangeSearch(currentCategoryPage + 1)}
  ...
  <>
   <div className="container mx-auto w-full  font-patrick">
        <div className="my-7 font-bold relative w-full flex justify-center items-center">
          <h1 className="text-white text-[40px]">Category <span className='text-[#b6feff]' >
          {name} </span> </h1>
