...
const LandingPage = () => {
  ...
  useEffect(() => {
    ...
    fetchData();
  }, [currentPageSearch, status_id, searchTerm, baseURL]);
              ...
              <>
                <div className="container mx-auto  font-patrick">
                  <div className="my-5 font-bold relative w-full justify-center items-center">
                    <h1 className=" flex flex-col text-white text-[30px] justify-center items-center lg:flex-row">
                      Hasil Pencarian :{' '}
                      <span className="text-[#b6feff]">{searchTerm} </span>{' '}
                    </h1>
