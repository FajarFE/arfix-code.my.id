    ...
    <>
      <nav className="font-patrick ">
        <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
          <div className="relative flex  items-start justify-between h-[100px] py-2 ">
            ...
            <div className="flex h-auto  w-full items-center gap-2 md:flex-col lg:flex-row justify-center sm:items-center sm:justify-between">
              ...
              <div className="flex justify-between items-center gap-10">
                <form
                  ...
                  className=" sm:ml-6 sm:block items-center relative flex justify-center"
                >
                  <button
                    type="submit"
                  ...
                  <input
                    ...
                    className="w-[400px] text-white p-4 focus:outline-none bg-[#1F2937] h-8 rounded-full"
                    placeholder="Search"
                  />
                </form>
                <div className="flex items-center gap-4  sm:flex  lg:flex">
                  <Link to="/login">
                    <button
                      className={`text-[15px] font-bold text-gray bg-[#1F2937] uppercase justify-center w-[120px]  px-4 h-[35px] outline-3 hover:bg-white hover:text-gray rounded-full p-1 flex items-center hover:outline-none`}
      ...
      {openFrontend && (
        ...
        >
          <div
            className=" max-w-7xl px-2 flex justify-start items-start sm:px-6 lg:px-8 mx-auto "
            style={{ height: '180px' }}
          >
      ...
      {openFullstack && (
        ...
        >
          <div
            className="mx-auto max-w-7xl px-2 flex justify-start items-start sm:px-6 lg:px-8  "
            style={{ height: '180px' }}
          >
            <div className="py-1 text-white gap-2 flex flex-col" role="none">
          ...
          <div class="px-2 pb-3 flex flex-col">
            ...
            {openBackend && (
              <div className="bg-gray-900 text-white block rounded-md px-3 py-2 text-base font-medium">
                {isBack.map((backend) => (
                  <Link
                    to={`/${backend.id}/${backend.name}/${backend.tipe_name}`}
                    key={backend.id}
                    className="text-gray-700 block px-4 py-2 text-md font-bold capitalize "
                    role="menuitem"
                    tabIndex="-1"
            ...
            {openFullstack && (
              <div className="bg-gray-900 text-white block rounded-md px-3 py-2 text-base font-medium">
                {isFull.map((fullstack) => (
                  <Link
                    to={`/${fullstack.id}/${fullstack.name}/${fullstack.tipe_name}`}
                    key={fullstack.id}
                    className="text-gray-700 block px-4 py-2 text-md font-bold capitalize "
                    role="menuitem"
                    tabIndex="-1"
            ...
            <form
              onSubmit={handleSubmit}
              className=" items-center relative flex justify-center"
            >
              <button className="absolute inset-y-0 buttom-[20px] right-0 pl-3 flex items-center  h-auto">
                <svg
                  width="27px"
                  height="27px"
                  viewBox="0 0 24 24"
              ...
              <input
                ...
                value={searchTerm}
                onChange={handleChange}
                className="w-[350px] p-4 focus:outline-none bg-[#fff] h-8 rounded-full text-[#000000]"
                placeholder="Search"
              />
            </form>
            <div className="flex justify-center items-center mt-2">
              <Link
                ...
                onMouseEnter={handleMouseEnter}
                onMouseLeave={handleMouseLeave}
                className={`text-[15px] font-bold text-[#000000] bg-[#ffffff] text-dark uppercase  w-[120px] justify-between px-4 h-[35px] outline-3 hover:bg-white hover:text-gray rounded-full p-1 flex items-center hover:outline-none`}
              >
                <svg
                  width="26px"
                  height="26px"
