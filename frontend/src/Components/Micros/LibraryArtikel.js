...
import { fetchPosts, setTotalPage } from '../Store/PostsSlice';
...
function Detail() {
  ...
  }, [dispatch, statusId, currentPage, createAt]);
        ...
        <div className="sm:px-6 w-full">
          <div className="px-4 md:px-10 py-4 md:py-7">
            <div className="flex items-center justify-center">
              <p className="text-base sm:text-lg md:text-xl lg:text-[30px] font-bold leading-normal text-[200px] text-gray-800">
                Library Artikel
              </p>
            </div>
          </div>
          <div className="bg-white py-4 md:py-7 px-4 md:px-8 xl:px-10">
            <div className="sm:flex items-center justify-between">
              <div className="flex items-center">
                <button onClick={handleAllStatusChange}>
                  <div
                    className={`py-2 px-8 ${
                ...
                <button onClick={handlePublishStatusChange}>
                  <div
                    className={`py-2 px-8 ${
                ...
                <button onClick={handleArchivedStatusChange}>
                  <div
                    className={`py-2 px-8 ${
                ...
                <button onClick={handleDraftStatusChange}>
                  <div
                    className={`py-2 px-8 ${
              ...
              <div className="w-20">
                {selectedPosts.length > 0 && (
                  <button
                    className="w-10 h-10 px-2 py-1 rounded-[5px]  bg-[#DB005B] flex justify-center items-center"
                ...
                <tbody className="gap-2 w-full flex-col justify-center items-center flex">
                  {data &&
                    ...
                    data.data.map((item, index) => (
                      <tr className="justify-between rounded-[20px] w-full items-center flex h-16 border  border-gray rounded-m">
                        <td>
                          <div className="ml-5">
                        ...
                        <td className="pl-24">
                          <div className="flex items-center">
                            ...
                            <p className="text-sm leading-none text-gray-600 capitalize ml-2">
                              {item.status_name}
                            </p>
                          </div>
                        </td>
