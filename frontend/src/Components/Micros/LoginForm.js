...
const LoginForm = () => {
  ...
  }, [navigate]); // Tambahkan array kosong sebagai argumen kedua useEffect untuk memastikan efek hanya dieksekusi sekali
      ...
      <div className="bg-dark w-screen h-screen overflow-hidden flex justify-center items-center  ">
        <div className="container  mx-auto ">
          ...
          <div className=" grid grid-cols-12 gap-4  ">
            <div className="col-span-12  flex-col lg:col-span-5 order-last flex justify-center items-center lg:order-first">
              <h1 className="text-[50px] font-bold hidden lg:flex -mb-32 mt-20 text-white w-full flex-col  justify-center items-center">
                Login
              </h1>
              <div className="flex flex-col w-[70%] items-center justify-center h-full">
                ...
                >
                  ...
                  <button
                    className="bg-purple  py-2 rounded-[10px] font-bold text-white"
                    type="submit"
                  >
                    Login
                  </button>
