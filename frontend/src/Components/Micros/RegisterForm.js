        ...
        <div className="container mx-auto ">
          ...
          <div className="grid grid-cols-12 gap-4">
            <div className="col-span-12 lg:col-span-5 order-last lg:order-first ">
              <h1 className="text-[50px] font-bold  lg:flex -mb-32 mt-20 text-white w-full flex-col flex justify-center items-center">
                Login
              </h1>
              <div className="flex flex-col items-center justify-center h-full   lg:w-full">
                <form
                  onSubmit={handleSubmit}
                  className="flex flex-col w-[70%] lg:w-full gap-5  my-5"
                >
                  {error && (
                  ...
                  <label className="flex flex-row w-full flex-warp gap-2">
                    <div className="w-[50%]">
                      ...
                      <input
                        className="focus:outline-gray w-full focus:outline-[3px] focus:outline focus:bg-white  py-2 px-4 rounded-[10px] bg-gray-light"
                        type="password"
                        value={password}
                ...
                <span className="text-white">
                  ...
                  <Link to="/login" className="text-[#ffffff]">
