...
const Headline = () => {
  ...
  <div className="grid grid-cols-12 container px-4 lg:px-0 md:px-0 gap-5 h-auto flex justify-center  items-center">
    {data && Array.isArray(data.data) && (
      <>
        <div className="col-span-12 lg:col-span-8 sm:col-span-12 md:col-span-12 rounded-[20px] h-[200px] sm:h-[200px] md:h-[400px] sm:w-[70%] md:w-full lg:w-full w-full flex justify-center items-center">
          <a href={`/${data.data[currentIndex].title}/${data.data[currentIndex].id}`} className="w-[100%] lg:w-full md:w-full rounded-md h-full justify-conten bg-white relative">
            <img src={data.data[currentIndex].paths[0]} alt="" className="object-fit w-full h-full" />
        ...
        <div className="col-span-12 md:col-span-12 hidden sm:hidden lg:block lg:col-span-4 rounded-[20px] pt-3 pb-20 h-[400px] w-full flex justify-center items-start">
          <div className="flex gap-5 flex-col justify-between items-start lg:justify-between lg:items-start md:justify-center md:items-center gap-2 h-full text-white font-patrick w-full">
